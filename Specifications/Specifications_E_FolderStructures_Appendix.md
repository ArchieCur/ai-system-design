# Specifications_E_FolderStructures_Appendix

*Converted from PDF: Specifications_E_FolderStructures_Appendix.pdf*
...
Unlike Skills folders (which teach HOW), Spec folders define WHAT (policies, compliance,
context).

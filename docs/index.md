...
**🚀 [Advanced Prompting](multi-agent/multi-agent-index.md)**  
Master advanced prompting techniques, automated optimization, and building reliable AI agents.
...
- **[Quick Reference Guide](specifications/Specifications_C_QuickReferenceGuide_Appendix.md)** - Fast lookup for key concepts
- **[Templates](specifications/Specifications_A_Templates_Appendix.md)** - Ready-to-use specification templates
- **[Common Pitfalls](specifications/Specifications_7_Common_Pitfalls.md)** - Avoid common mistakes
...
Found an issue or want to contribute? Visit the [GitHub repository](https://github.com/ArchieCur/ai-system-design) to report bugs, suggest improvements, or submit pull requests.

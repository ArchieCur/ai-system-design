...
![Mental Model of AI 2024 vs 2026)](../assets/Reliable_Mental_models.png)
...
![Decomposition using ITE to Fix Agent Failures](../assets/Using_ITE_to_fix_agent_failures.png)
...
![Harness Architecture with I, T, E Design Choices](../assets/Applying_ITE_to_the_Harness.png)
...
![Isolating Structure, Logic and Syntax Failures with ITE](../assets/Isolating_Failure_Type.png)
...
**Use this when:**
Your agent is failing and you're not sure if it's Instructions (I), State/Reasoning (T), or Examples (E).

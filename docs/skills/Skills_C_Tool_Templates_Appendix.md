# Skills_C_Tool_Templates_Appendix

*Converted from PDF: Skills_C_Tool_Templates_Appendix.pdf*
...
There are 3 tool templates included. A Fill-in-the-Blank template for intermediate to advanced
users. A Minimal template for simple tools. And a template for Non-Coders.

Tool Definition Template: Fill-in-the-Blank Edition

Instructions: Replace all [BLANK] sections with your specific information. Delete optional
...
"confirmation_template": "This will send an email to {to} with subject '{subject}'. Proceed?
(yes/no)",
...
Parameter 1: ____________________

Parameter 2: ____________________

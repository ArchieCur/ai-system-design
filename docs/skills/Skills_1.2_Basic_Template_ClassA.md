...
*Converted from PDF: Skills_1.2_Basic_Template_ClassA.pdf*
...
Section 1.2: Basic Skills Template (Class A)
...
Done with worksheet? → Jump to "Your Completed Template" section below to assemble your
skill!
...
• Oxford_Comma (uppercase, underscore)
...
What should the AI NOT do with this skill?
...
### The AI should use this skill when:
...
• "User needs help writing" (too vague)
...
Copy this template, replace the [BLANKS] with your answers from Part 1 or Part 2, and save as
...
On Other Platforms: See Appendix D: Cross-Platform Implementation for OpenAI/Gemini
instructions.
...
• Section 1.4: Learn all 19 semantic tags (you used 3 basic ones)
...
• Section 2.3: Combating Attentional Residue (why unload conditions matter)
...
Congratulations! You've mastered Class A skills. When you're ready for more complexity, see
Section 1.3 (Advanced Skills).

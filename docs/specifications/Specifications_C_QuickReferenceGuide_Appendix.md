# Specifications_C_QuickReferenceGuide_Appendix

*Converted from PDF: Specifications_C_QuickReferenceGuide_Appendix.pdf*
...
Layer Purpose Key Question Output Format

Hard
MUST "What cannot be violated?" <constraint priority="critical">
boundaries
Flexible "What's preferred but <guideline

## SHOULD

preferences negotiable?" priority="high/medium/low">
Planning "What
CONTEXT <context scope="domain">
information environment/situation?"

"What are we trying to
INTENT The why <intent scope="domain">
achieve?"
"How do we know we
VERIFICATION Self-checking <verification scope="domain">
succeeded?"
...
RATIONALE: [User base breakdown, integration needs]
...
**Primary Goal:** [One sentence goal with metric]
...
- [What we prioritize over]: [rationale]
...
VERIFICATION Layer Quick Reference
...
**What to verify:** [Specific constraint]
...
**What to verify:** [Specific criteria]
...
MUST: [Most critical 3-5 requirements]
